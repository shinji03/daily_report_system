        ...
        <div id="header">
            <div id="header_menu">
                ...
                <c:if test="${sessionScope.login_employee != null}">
                    ...
                    <a href="<c:url value='?action=${actRep}&command=${commIdx}' />">全スタッフ日報一覧</a>&nbsp;
                </c:if>
            </div>
            <c:if test="${sessionScope.login_employee != null}">
                <div id="employee_name">
                    <c:out value="${sessionScope.login_employee.name}" />&nbsp;さん&nbsp;&nbsp;&nbsp;<a href="<c:url value='?action=${actAuth}&command=${commOut}' />">ログアウト</a>
                </div>
            </c:if>
        </div>
