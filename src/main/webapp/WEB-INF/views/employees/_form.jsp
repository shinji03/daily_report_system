...
<label for="${AttributeConst.EMP_MANAGEMENT_FLAG.getValue()}">役職</label>
<br />
<select name="${AttributeConst.EMP_MANAGEMENT_FLAG.getValue()}"
	id="${AttributeConst.EMP_MANAGEMENT_FLAG.getValue()}">

	<option value="${AttributeConst.POSITION_GENERAL.getIntegerValue()}"
		<c:if test="${employee.managementFlag == AttributeConst.POSITION_GENERAL.getIntegerValue()}"> selected</c:if>>一般</option>

	<option value="${AttributeConst.POSITION_SUPERIOR.getIntegerValue()}"
		<c:if test="${employee.managementFlag == AttributeConst.POSITION_SUPERIOR.getIntegerValue()}"> selected</c:if>>上長</option>

	<option value="${AttributeConst.POSITION_MANAGER.getIntegerValue()}"
		<c:if test="${employee.managementFlag == AttributeConst.POSITION_MANAGER.getIntegerValue()}"> selected</c:if>>部長</option>
</select>
<br />
<br />
