        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td><c:choose>
                            <c:when
                                test="${employee.managementFlag == AttributeConst.POSITION_MANAGER.getIntegerValue()}">部長</c:when>
                            <c:when
                                test="${employee.managementFlag == AttributeConst.POSITION_SUPERIOR.getIntegerValue()}">上長</c:when>
